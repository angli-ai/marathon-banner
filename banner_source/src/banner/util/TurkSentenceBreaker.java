...
public class TurkSentenceBreaker {

    private String text;
    private List<String> sentences;

    public TurkSentenceBreaker() {
        // Empty
    }
    ...
    public static void main(String[] args) {
        ...
        sb.setText("This is short. I am Dodge. Dr. Peterson is a bad guy ?-hehe something. Testing (A. B. C. E.) also. And another.");
